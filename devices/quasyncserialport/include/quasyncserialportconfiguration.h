...
class QUDEVICE_EXPORT QUAsyncSerialPortConfiguration : public QUConfiguration {
    Q_OBJECT
...
public:
    explicit QUAsyncSerialPortConfiguration(QObject* parent = nullptr);
    ~QUAsyncSerialPortConfiguration() = default;
